...
if(isset($submit))
{
	$rs=mysql_query("select * from user where loginid='$login' and pass='$psw'");
...
{
	header('Location: http://localhost/Complaint_System/RequestRegister.php');
...
<div class="container">
	...
	<div align=\"right\"><strong><a href="mypage.php"> User login </a>&nbsp|&nbsp<a href="mypageadmin.php">Admin login</a></strong></div><br>
